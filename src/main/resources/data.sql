insert into usr (social, email, pwd, nm, ph_num, cash, use_yn, rgs_dt, upd_dt) values ('NONE' ,'hijinhoon@naver.com', 'admin', '관리자', '01050188147', 35000, true, now(), now());
...
insert into usr_cash (usr_id, cash_type, charging_amount, remaining_amount, expiry_time, rgs_dt, upd_dt) values (1, 'CHARGING', 10000, 10000, TIMESTAMPADD(DAY, 1, now()), now(), now());
insert into usr_cash (usr_id, cash_type, charging_amount, remaining_amount, expiry_time, rgs_dt, upd_dt) values (1, 'CHARGING', 20000, 20000, TIMESTAMPADD(DAY, 1, now()), now(), now());
insert into usr_cash (usr_id, cash_type, charging_amount, remaining_amount, expiry_time, rgs_dt, upd_dt) values (1, 'SAVING', 5000, 5000, TIMESTAMPADD(DAY, 1, now()), now(), now());
