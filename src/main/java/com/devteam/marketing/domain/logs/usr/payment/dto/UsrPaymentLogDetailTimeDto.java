...
@Getter @Setter
public class UsrPaymentLogDetailTimeDto extends BaseTimeDto {
    ...
    public static UsrPaymentLogDetailTimeDto of(UsrPaymentLog usrPaymentLog) {
        final UsrPaymentLogDetailTimeDto usrPaymentLogDetailDto = UsrPaymentLogDtoMapper.INSTANCE.toUsrPaymentLogDetailDto(usrPaymentLog);
        usrPaymentLogDetailDto.setUsr(UsrSimpleDto.of(usrPaymentLog.getUsr()));
        return usrPaymentLogDetailDto;
    }

    public static List<UsrPaymentLogDetailTimeDto> of(List<UsrPaymentLog> usrPaymentLogs) {
        return usrPaymentLogs.stream().map(UsrPaymentLogDetailTimeDto::of).collect(Collectors.toList());
    }
